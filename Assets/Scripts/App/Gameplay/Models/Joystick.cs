...
namespace Models
{
    ...
    public class Joystick
    {
        ...
        {
            get => (_snapX) ? SnapFloat(_input.x, AxisOptions.Horizontal) : _input.x;
        }

        public float Vertical
        {
            get => (_snapY) ? SnapFloat(_input.y, AxisOptions.Vertical) : _input.y;
        }
        ...
        public void SetAxisOptions(AxisOptions axisOptions)
        {
